...
//244 a 247 couper la visualisation
    ...
    private void start() {
        ...
        /* replacement */ _bCMS_state_machine.fires(_Enough_police_vehicles_arrived, _Police_vehicles_arriving, _End_of_police_vehicles_arrival, this, "police_vehicle_arrived_greater_than_or_equal_to_police_vehicle_dispatched_and_in_All_fire_trucks_arrived");
            ...
            Long lcountFT =  serviceR.countFireTruck();
             Long lcountPV =  serviceR.countPoliceVehicle();
                          System.out.println("APRESS ICICICIICIC");
             ...
             System.out.println("APRESS ENCORE");
             fire_truck_dispatched("FireTruck1");
                          System.out.println("cicicici et lalalalal ENCORE");
